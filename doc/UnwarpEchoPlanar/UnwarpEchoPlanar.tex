...
CMTK release 2.2.4\footnote{Has not been released yet. Please obtain latest
CMTK source code from Subversion repository,
\url{https://www.nitrc.org/svn/cmtk/trunk/core/}.} or later.} Versions prior
