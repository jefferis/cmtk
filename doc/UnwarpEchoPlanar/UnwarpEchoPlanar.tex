...
\begin{center}
\begin{tabular}{cc}
\includegraphics[width=.475\linewidth]{eps/b0_rev} &
...
\begin{center}
\begin{tabular}{cc}
\includegraphics[width=.475\linewidth]{eps/unwarp/b0_rev} &
\includegraphics[width=.475\linewidth]{eps/unwarp/b0_fwd} \\
(a) \texttt{b0\_rev.nii.gz} & (b)  \texttt{b0\_fwd.nii.gz}\\
\\
\end{tabular}
\begin{tabular}{ccc}
\includegraphics[width=.31\linewidth]{eps/unwarp/b1} &
\includegraphics[width=.31\linewidth]{eps/unwarp/b2} &
\includegraphics[width=.31\linewidth]{eps/unwarp/b3} \\
(c) \texttt{b1.nii.gz} & (d) \texttt{b2.nii.gz} & (e) \texttt{b3.nii.gz} \\
\\
\includegraphics[width=.31\linewidth]{eps/unwarp/b4} &
\includegraphics[width=.31\linewidth]{eps/unwarp/b5} &
\includegraphics[width=.31\linewidth]{eps/unwarp/b6} \\
(f) \texttt{b4.nii.gz} & (g) \texttt{b5.nii.gz} & (h) \texttt{b6.nii.gz} \\
\end{tabular}
\end{center}
...
\end{tabular}
\begin{tabular}{ccc}
\includegraphics[width=.31\linewidth]{eps/unwarp_eddy/b1} &
\includegraphics[width=.31\linewidth]{eps/unwarp_eddy/b2} &
\includegraphics[width=.31\linewidth]{eps/unwarp_eddy/b3} \\
(c) \texttt{b1.nii.gz} & (d) \texttt{b2.nii.gz} & (e) \texttt{b3.nii.gz} \\
\\
\includegraphics[width=.31\linewidth]{eps/unwarp_eddy/b4} &
\includegraphics[width=.31\linewidth]{eps/unwarp_eddy/b5} &
\includegraphics[width=.31\linewidth]{eps/unwarp_eddy/b6} \\
(f) \texttt{b4.nii.gz} & (g) \texttt{b5.nii.gz} & (h) \texttt{b6.nii.gz} \\
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{cc}
\includegraphics[width=.475\linewidth]{eps/unwarp_eddy_motion/b0_rev} &
\includegraphics[width=.475\linewidth]{eps/unwarp_eddy_motion/b0_fwd} \\
(a) \texttt{b0\_rev.nii.gz} & (b)  \texttt{b0\_fwd.nii.gz}\\
\\
\end{tabular}
\begin{tabular}{ccc}
\includegraphics[width=.31\linewidth]{eps/unwarp_eddy_motion/b1} &
\includegraphics[width=.31\linewidth]{eps/unwarp_eddy_motion/b2} &
\includegraphics[width=.31\linewidth]{eps/unwarp_eddy_motion/b3} \\
(c) \texttt{b1.nii.gz} & (d) \texttt{b2.nii.gz} & (e) \texttt{b3.nii.gz} \\
\\
\includegraphics[width=.31\linewidth]{eps/unwarp_eddy_motion/b4} &
\includegraphics[width=.31\linewidth]{eps/unwarp_eddy_motion/b5} &
\includegraphics[width=.31\linewidth]{eps/unwarp_eddy_motion/b6} \\
(f) \texttt{b4.nii.gz} & (g) \texttt{b5.nii.gz} & (h) \texttt{b6.nii.gz} \\
\end{tabular}
\end{center}
