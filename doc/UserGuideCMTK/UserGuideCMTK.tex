...
%%DRAFT%%\subsection{General Linear Modeling}
%%DRAFT%%
%%DRAFT%%\cite{FrisHolmWors:1995}
...
%%DRAFT%%\clearpage
%%DRAFT%%\section{Atlas Construction}
%%DRAFT%%
%%DRAFT%%In addition to being useful for atlas-based segmentation, CMTK also provides
%%DRAFT%%tools that can be used in the construction of atlases. Indeed, its tools have
%%DRAFT%%been used to create various published atlases.
%%DRAFT%%
%%DRAFT%%\subsection{Iterative Shape Averaging}
%%DRAFT%%
%%DRAFT%%The iterative shape averaging (ISA) procedure~\cite{RohlBranMaur:2001} was
%%DRAFT%%first used to create a standard atlas of the honeybee
%%DRAFT%%brain~\cite{BranRohlRyba:2005}, and has since been applied to other insect
%%DRAFT%%species as well~\cite{KuryRohlKrof:2008,KvelLofaRyba:2009}.
%%DRAFT%%
%%DRAFT%%\begin{verbatim}
%%DRAFT%%sh iterative_shape_averaging.sh ref_image.nii flt_image1.nii  flt_image2.nii
%%DRAFT%%\end{verbatim}
%%DRAFT%%
%%DRAFT%%\subsection{Averaging Pairwise Correspondences}
%%DRAFT%%
%%DRAFT%%\cite{GuimMeunThir:2000}
%%DRAFT%%
%%DRAFT%%\cite{JeffPottChan:2007}
%%DRAFT%%
%%DRAFT%%\subsection{Groupwise Population Registration}
%%DRAFT%%
%%DRAFT%%\cite{Learned-Miller:2006}
%%DRAFT%%\cite{BalcGollShen:2007}
%%DRAFT%%\cite{RohlZahrSull:2008,RohlZahrSull:2010}
%%DRAFT%%
%%DRAFT%%\clearpage
%%DRAFT%%\section{More Gory Details}
%%DRAFT%%
%%DRAFT%%\subsection{Registration Options for Image Pre-Processing}
%%DRAFT%%
%%DRAFT%%Both the affine and nonrigid pairwise image registration, \verb|registration|
%%DRAFT%%and \verb|warp|, support a number of pre-processing operations that can be
%%DRAFT%%applied to the reference and floating image on-the-fly, prior to
%%DRAFT%%registration. The most commonly used of these are:
%%DRAFT%%\begin{itemize}
%%DRAFT%%\item {\em Data Class:\/} For each image, the ``class'' of the image data can
%%DRAFT%%  be defined. This can be ``grey,'' ``binary,'' or ``label.'' Typically, both
%%DRAFT%%  images should have data in the same class. When the data class is set to
%%DRAFT%%  ``label,'' the registration algorithm uses nearest neighbour instead of
%%DRAFT%%  trilinear interpolation, and the numbers of histogram bin are set to the
%%DRAFT%%  number of labels in each image rather than being adjusted based on the
%%DRAFT%%  intensity range and number of pixels.
%%DRAFT%%\item {\em Thresholding:\/} Upper and lower thresholds can be defined to
%%DRAFT%%  truncate the image intensities.
%%DRAFT%%\item {\em Cropping:\/} Images can be cropped, based on either image index
%%DRAFT%%  ranges or image coordinate ranges. The \verb|registration| tool implements a
%%DRAFT%%  volume clipping algorithm~\cite{Rohlfing:2003} that considerably speeds up
%%DRAFT%%  registration of cropped images. Cropping can also improve registration
%%DRAFT%%  accuracy and robustness by excluding non-informative areas of the images.
%%DRAFT%%\item {\em Histogram Pruning:\/} For a given number of histogram bins (128 is
%%DRAFT%%  typically a good value), this operation truncates the intensity range of the
%%DRAFT%%  image such that both the lowest and the highest histogram bin receive
%%DRAFT%%  1/NumberOfBins of the total number of image samples. This is quite effective
%%DRAFT%%  to prevent degeneration of histograms by extreme image intensities due to
%%DRAFT%%  noise.
%%DRAFT%%\end{itemize}
%%DRAFT%%
%%DRAFT%%{\em Histogram Matching:\/} Using the \verb|--match-histograms| option, the
%%DRAFT%%intensities of the floating image can be rescaled to match the distribution of
%%DRAFT%%the reference image. This is a common pre-processing operator to allow, for
%%DRAFT%%example, registration of inter-subject images using the mean squared
%%DRAFT%%differences metric.
%%DRAFT%%
%%DRAFT%%{\em Setting value outside FOV:\/} A default value for data outside the
%%DRAFT%%floating image FOV can be defined using the \verb|--force-outside-value|
%%DRAFT%%option. This artificially inreases the overlapping image region that can be
%%DRAFT%%considered for registration, which may help increase registration robustness. 
%%DRAFT%%
%%DRAFT%%\subsection{Nonrigid Registration Options}
%%DRAFT%%
%%DRAFT%%\verb|--delay-refine|
%%DRAFT%%
%%DRAFT%%\verb|--exact-spacing|
%%DRAFT%%
%%DRAFT%%\verb|--delay-refine|
%%DRAFT%%
%%DRAFT%%\verb|--restrict|
...
%%DRAFT%%\verb|--accurate|
%%DRAFT%%
%%DRAFT%%\verb|--delta-f-threshold|
%%DRAFT%%
%%DRAFT%%\verb|--ic-weight| \cite{ChriJohn:2001}
%%DRAFT%%
%%DRAFT%%\verb|--relax| \cite{RohlMaurBlue:2003b}
