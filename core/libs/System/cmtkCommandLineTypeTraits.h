...
class CommandLineTypeTraitsBase {
 public:
  ...
  /// Convert a value of this type to string with minimal added markup (for XML
  /// output).
...
class CommandLineTypeTraits<std::vector<std::string>>
 ...
 public:
  static const char *GetName() { return "vector<string>"; }

  static std::string ValueToString(const std::vector<std::string> &value) {
    std::ostringstream stream;
    for (size_t i = 0; i < value.size(); ++i) stream << value[i] << " ";
    return stream.str();
  }

  /// Convert a value of this type to string with minimal added markup (for XML
  /// output).
  static std::string ValueToStringMinimal(
...
class CommandLineTypeTraits<int>
 ...
 public:
  static const char *GetName() { return "integer"; }
};
...
class CommandLineTypeTraits<signed char>
 ...
 public:
  ...
  /// Convert a value of this type to numerical string with minimal added markup
  /// (for XML output).
