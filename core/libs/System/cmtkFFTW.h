 ...
 * Among other things, this class handles the initialization and destruction of
 * global FFTW properties, such as threads support.
 */
class FFTW {
 public:
  /// This class.
   ...
   * The number of threads applies only to subsequently created plans.
   * Previously created plans retain their original number of threads when
   * executed.
   */
