...
void StackBacktrace ::PrintBacktrace(const int levels) {
#ifdef HAVE_EXECINFO_H
  void *trace[16];
  ...
  for (int i = 1; i < printLevels; ++i) printf("[stack] %s\n", messages[i]);
...
#ifndef _MSC_VER
void cmtkStackBacktraceSignalHandler(int sig, siginfo_t *info, void *) {
...
void cmtkStackBacktraceSignalHandler(int sig) {
  exit(cmtk::StackBacktrace::ExitCode);
}
#endif  // #ifndef _MSC_VER
