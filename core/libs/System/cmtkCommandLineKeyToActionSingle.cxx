...
mxml_node_t *cmtk::CommandLine::KeyToActionSingle ::MakeXML(
...
void cmtk::CommandLine::KeyToActionSingle ::PrintHelp(
    const size_t globalIndent, const bool advanced) const {
  std::ostringstream fmt;
  this->Superclass::FormatHelp(fmt);

  if (((this->m_Action->GetProperties() & Self::PROPS_ADVANCED) == 0) ||
      advanced) {
...
void cmtk::CommandLine::KeyToActionSingle ::PrintWikiWithPrefix(
...
void cmtk::CommandLine::KeyToActionSingle ::PrintManWithPrefix(
    const std::string &prefix) const {
...
bool cmtk::CommandLine::KeyToActionSingle ::MatchAndExecute(
