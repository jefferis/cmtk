...
class CubicSpline {
 public:
  ...
  static Types::Coordinate ApproxSpline(const int k,
                                        const Types::Coordinate t) {
    switch (k) {
      case 0:
        return ApproxSpline0(t);
      case 1:
        return ApproxSpline1(t);
      case 2:
        return ApproxSpline2(t);
      case 3:
        return ApproxSpline3(t);
      default:
        return 0;
    }
#ifdef MSDOS
  ...
  static Types::Coordinate DerivApproxSpline(const int k,
                                             const Types::Coordinate t) {
    switch (k) {
      case 0:
        return DerivApproxSpline0(t);
      case 1:
        return DerivApproxSpline1(t);
      case 2:
        return DerivApproxSpline2(t);
      case 3:
        return DerivApproxSpline3(t);
      default:
        return 0;
    }
#ifdef MSDOS
  ...
  static Types::Coordinate SecondDerivApproxSpline(const int k,
                                                   const Types::Coordinate t) {
    switch (k) {
      case 0:
        return SecondDerivApproxSpline0(t);
      case 1:
        return SecondDerivApproxSpline1(t);
      case 2:
        return SecondDerivApproxSpline2(t);
      case 3:
        return SecondDerivApproxSpline3(t);
      default:
        return 0;
    }
#ifdef MSDOS
  ...
  static Types::Coordinate InterpSpline(const int k,
                                        const Types::Coordinate t) {
    switch (k) {
      case 0:
        return InterpSpline0(t);
      case 1:
        return InterpSpline1(t);
      case 2:
        return InterpSpline2(t);
      case 3:
        return InterpSpline3(t);
      default:
        return 0;
    }
#ifdef MSDOS
  ...
  static Types::Coordinate DerivInterpSpline(const int k,
                                             const Types::Coordinate t) {
    switch (k) {
      case 0:
        return DerivInterpSpline0(t);
      case 1:
        return DerivInterpSpline1(t);
      case 2:
        return DerivInterpSpline2(t);
      case 3:
        return DerivInterpSpline3(t);
      default:
        return 0;
    }
#ifdef MSDOS
  ...
  static Types::Coordinate SecondDerivInterpSpline(const int k,
                                                   const Types::Coordinate t) {
    switch (k) {
      case 0:
        return SecondDerivInterpSpline0(t);
      case 1:
        return SecondDerivInterpSpline1(t);
      case 2:
        return SecondDerivInterpSpline2(t);
      case 3:
        return SecondDerivInterpSpline3(t);
      default:
        return 0;
    }
#ifdef MSDOS
