...
template <class T>
cmtk::CompatibilityMatrix4x4<T>::CompatibilityMatrix4x4(
    const CoordinateVector &dofs, const bool logScaleFactors) {
  ...
  this->m_Matrix[1][0] =
      static_cast<T>((sin0xsin1 * cos2 + cos0 * sin2) * scaleY);
  this->m_Matrix[1][1] =
      static_cast<T>((-sin0xsin1 * sin2 + cos0 * cos2) * scaleY);
  this->m_Matrix[1][2] = static_cast<T>(sin0 * cos1 * scaleY);
  this->m_Matrix[1][3] = static_cast<T>(0);
  this->m_Matrix[2][0] =
      static_cast<T>((cos0xsin1 * cos2 - sin0 * sin2) * scaleZ);
  this->m_Matrix[2][1] =
      static_cast<T>((-cos0xsin1 * sin2 - sin0 * cos2) * scaleZ);
  this->m_Matrix[2][2] = static_cast<T>(cos0 * cos1 * scaleZ);
  this->m_Matrix[2][3] = static_cast<T>(0);

  this->m_Matrix[3][0] = this->m_Matrix[3][1] = this->m_Matrix[3][2] =
      static_cast<T>(0);
  ...
  const Types::Coordinate cM[3] = {
      dofs[12] * this->m_Matrix[0][0] + dofs[13] * this->m_Matrix[1][0] +
          dofs[14] * this->m_Matrix[2][0],
      dofs[12] * this->m_Matrix[0][1] + dofs[13] * this->m_Matrix[1][1] +
          dofs[14] * this->m_Matrix[2][1],
      dofs[12] * this->m_Matrix[0][2] + dofs[13] * this->m_Matrix[1][2] +
          dofs[14] * this->m_Matrix[2][2]};
