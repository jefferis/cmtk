...
public:
  ...
  {
    ImageOperation::m_ImageOperationList.push_back( SmartPtr( new ImageOperationThreshold( threshold, false, false ) ) );
  }
  
  /// Create a new upper thresholding operation.
  static void NewAbove( const double threshold )
  {
    ImageOperation::m_ImageOperationList.push_back( SmartPtr( new ImageOperationThreshold( threshold, true, false ) ) );
  }
  
  /// Create a new lower thresholding operation to padding.
  static void NewBelowToPadding( const double threshold )
  {
    ImageOperation::m_ImageOperationList.push_back( SmartPtr( new ImageOperationThreshold( threshold, false, true ) ) );
  }
  
  /// Create a new upper thresholding operation to padding.
  static void NewAboveToPadding( const double threshold )
  {
    ImageOperation::m_ImageOperationList.push_back( SmartPtr( new ImageOperationThreshold( threshold, true, true ) ) );
  }
