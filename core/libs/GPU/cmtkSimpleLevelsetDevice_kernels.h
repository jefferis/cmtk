...
void SimpleLevelsetDeviceUpdateInsideOutside(
    float *levelset /*!< Input: current levelset */,
    float *volume /*!< Input: image data */,
    const int nPixels /*!< Input: number of pixels */,
...
/// Update levelset based on mean values in inside and outside regions, then
/// threshold the result.
void SimpleLevelsetDeviceUpdateLevelset(
    float *levelset /*!< Input/output: current levelset, is updated by this
                       function */
    ,
    float *volume /*!< Input: image data */,
    const int nPixels /*!< Input: number of pixels */,
