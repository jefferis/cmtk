...
ImagePairAffineRegistrationFunctionalDevice::
    ...
    : ImagePairRegistrationFunctional(fixedVolume, movingVolume),
      ...
      m_MovingVolumeOnDevice(
          DeviceUniformVolumeArray::Create(*(movingVolume))) {}
...
ImagePairAffineRegistrationFunctionalDevice::Evaluate() {
  ...
  return -ImagePairAffineRegistrationFunctionalDeviceEvaluateMSD(
      ...
      this->m_FixedVolumeOnDevice->GetDeviceArrayPtr()->GetArrayOnDevice(),
      this->m_FloatingGrid->m_Dims.begin(),
      this->m_MovingVolumeOnDevice->GetDeviceArrayPtr()->GetArrayOnDevice(),
      matrix);
}
