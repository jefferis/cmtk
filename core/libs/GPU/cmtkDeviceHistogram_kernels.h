...
void cmtkDeviceHistogramPopulate(
    float *histPtr,         /*!< Device pointer to histogram data (output). */
    ...
    const bool logScale,    /*!< Use log scale for value-to-bin mapping to make
                               entropy scale-invariant. */
...
void cmtkDeviceHistogramPopulate(
    float *histPtr,       /*!< Device pointer to histogram data (output). */
    const float *dataPtr, /*!< Device pointer to input image data. */
    const int *maskPtr,   /*!< Device pointer to binary mask data (0=background,
                             1=foreground). */
    const float rangeFrom,  /*!< Histogram range from this value. */
    const float rangeTo,    /*!< Histogram range to this value. */
    const bool logScale,    /*!< Use log scale for value-to-bin mapping to make
