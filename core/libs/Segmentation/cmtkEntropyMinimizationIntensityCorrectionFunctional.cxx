  ...
  switch (polynomialDegreeAdd) {
    case 0:
      functional = FunctionalPointer(
          new EntropyMinimizationIntensityCorrectionFunctional<0, NDegreeMul>);
      break;
    case 1:
      functional = FunctionalPointer(
          new EntropyMinimizationIntensityCorrectionFunctional<1, NDegreeMul>);
      break;
    case 2:
      functional = FunctionalPointer(
          new EntropyMinimizationIntensityCorrectionFunctional<2, NDegreeMul>);
      break;
    case 3:
      functional = FunctionalPointer(
          new EntropyMinimizationIntensityCorrectionFunctional<3, NDegreeMul>);
      break;
    case 4:
      functional = FunctionalPointer(
          new EntropyMinimizationIntensityCorrectionFunctional<4, NDegreeMul>);
      break;
    default:
      StdErr.printf(
...
CreateEntropyMinimizationIntensityCorrectionFunctional(
  ...
  switch (polynomialDegreeMul) {
    case 0:
      functional = CreateEntropyMinimizationIntensityCorrectionFunctional<0>(
          polynomialDegreeAdd);
      break;
    case 1:
      functional = CreateEntropyMinimizationIntensityCorrectionFunctional<1>(
          polynomialDegreeAdd);
      break;
    case 2:
      functional = CreateEntropyMinimizationIntensityCorrectionFunctional<2>(
          polynomialDegreeAdd);
      break;
    case 3:
      functional = CreateEntropyMinimizationIntensityCorrectionFunctional<3>(
          polynomialDegreeAdd);
      break;
    case 4:
      functional = CreateEntropyMinimizationIntensityCorrectionFunctional<4>(
          polynomialDegreeAdd);
      break;
    default:
