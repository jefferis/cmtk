...
class RegistrationJointHistogram :
 ...
 public:
   ...
   * is automatically determined.
   *\param boundsX Value range for the X data distribution. Values outside this
   *range will be assigned to the first and last histogram bins, respectively.
   *\param boundsY Value range for the Y data distribution. Values outside this
   *range will be assigned to the first and last histogram bins, respectively.
   */
  RegistrationJointHistogram(
      ...
      const Types::DataItemRange &boundsX = Types::DataItemRange(-HUGE_VAL,
                                                                 HUGE_VAL),
      const Types::DataItemRange &boundsY = Types::DataItemRange(-HUGE_VAL,
                                                                 HUGE_VAL));
   ...
   * value.
   */
  inline void Proceed(const size_t refIdx, const size_t fltIdx,
  ...
  void AddMetric(const Self &other) { this->AddJointHistogram(other); }

  /// Remove another metric, e.g., to undo results from an ROI in local
  /// computation.
  void RemoveMetric(const Self &other) { this->RemoveJointHistogram(other); }
};
