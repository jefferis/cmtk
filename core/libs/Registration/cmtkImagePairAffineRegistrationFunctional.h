 ...
 */
template<class VM>
class ImagePairAffineRegistrationFunctional_Template :
...
public:
  /// This class type.
  typedef ImagePairAffineRegistrationFunctional_Template<VM> Self;
   ...
   */
  ImagePairAffineRegistrationFunctional_Template( UniformVolume::SmartPtr& reference, UniformVolume::SmartPtr& floating, AffineXform::SmartPtr& affineXform )
  ...
  /// Destructor.
  virtual ~ImagePairAffineRegistrationFunctional_Template() 
  {
