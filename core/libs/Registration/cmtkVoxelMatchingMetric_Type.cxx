...
void VoxelMatchingMetric_Type<T, DT>::ImageData::Init(
...
template <class T, ScalarDataType DT>
size_t VoxelMatchingMetric_Type<T, DT>::ImageData::Init(
  ...
  this->m_ValueRange =
      Types::DataItemRange(0, static_cast<Types::DataItem>(numBins - 1));

  return (Padding = numBins);
}

template <class T, ScalarDataType DT>
void VoxelMatchingMetric_Type<T, DT>::ImageData::AllocDataArray(
...
template <class T, ScalarDataType DT>
void VoxelMatchingMetric_Type<T, DT>::ImageData::PrecomputeIncrements(
    const UniformVolume *volume) {
