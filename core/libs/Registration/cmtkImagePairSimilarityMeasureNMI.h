...
public:
  ...
  ImagePairSimilarityMeasureNMI( const UniformVolume::SmartPtr& refVolume, const UniformVolume::SmartPtr& fltVolume )
    : ImagePairSimilarityJointHistogram( refVolume, fltVolume )
  {}
  ...
  /// Copy constructor.
  ImagePairSimilarityMeasureNMI( const Self& src )
    : ImagePairSimilarityJointHistogram( src )
  {}

  /// Copy constructor.
  ImagePairSimilarityMeasureNMI( Self& other, const bool copyData = false )
