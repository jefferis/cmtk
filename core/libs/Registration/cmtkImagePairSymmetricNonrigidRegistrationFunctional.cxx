...
void ImagePairSymmetricNonrigidRegistrationFunctionalTemplate<
    VM, W>::SetWarpXform(SplineWarpXform::SmartPtr &warpFwd,
...
template <class VM, class W>
typename ImagePairSymmetricNonrigidRegistrationFunctionalTemplate<VM,
                                                                  W>::ReturnType
ImagePairSymmetricNonrigidRegistrationFunctionalTemplate<
    VM, W>::EvaluateWithGradient(CoordinateVector &v, CoordinateVector &g,
  ...
  const typename Self::ReturnType result =
      this->FwdFunctional.EvaluateWithGradient(vFwd, gFwd, step) +
...
ImagePairSymmetricNonrigidRegistrationFunctional ::Create(
  ...
  switch (metric) {
    case 0:
      return new ImagePairSymmetricNonrigidRegistrationFunctionalTemplate<
          ImagePairSimilarityMeasureNMI, SplineWarpXform>(refVolume, fltVolume,
                                                          interpolation);
    case 1:
      return new ImagePairSymmetricNonrigidRegistrationFunctionalTemplate<
          ImagePairSimilarityMeasureMI, SplineWarpXform>(refVolume, fltVolume,
                                                         interpolation);
    case 2:
      return new ImagePairSymmetricNonrigidRegistrationFunctionalTemplate<
          ImagePairSimilarityMeasureCR, SplineWarpXform>(refVolume, fltVolume,
                                                         interpolation);
    case 3:
      return NULL;  // masked NMI retired
    case 4:
      return new ImagePairSymmetricNonrigidRegistrationFunctionalTemplate<
          ImagePairSimilarityMeasureMSD, SplineWarpXform>(refVolume, fltVolume,
                                                          interpolation);
    case 5:
      return new ImagePairSymmetricNonrigidRegistrationFunctionalTemplate<
          ImagePairSimilarityMeasureNCC, SplineWarpXform>(refVolume, fltVolume,
                                                          interpolation);
    default:
      return NULL;
  }
