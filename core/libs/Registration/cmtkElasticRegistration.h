...
class ElasticRegistration :
 ...
 protected:
  ...
  const UniformVolume::SmartPtr GetReformattedFloatingImage(
      Interpolators::InterpolationEnum interpolator = Interpolators::LINEAR);
 ...
 private:
   ...
   */
  const SplineWarpXform::SmartPtr MakeWarpXform(
   ...
   */
  Functional *MakeFunctional(UniformVolume::SmartPtr &refVolume,
