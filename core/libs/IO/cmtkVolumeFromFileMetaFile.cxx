...
void VolumeFromFile::WriteMetaImage(const std::string &pathHdr,
  ...
  fprintf(outfile, "Offset = %lf %lf %lf\n", (double)matrix[3][0],
          (double)matrix[3][1], (double)matrix[3][2]);
  fprintf(outfile, "CenterOfRotation = 0 0 0\n");
  fprintf(outfile, "ElementSpacing = %f %f %f\n", volume.m_Delta[AXIS_X],
          volume.m_Delta[AXIS_Y], volume.m_Delta[AXIS_Z]);
  fprintf(outfile, "DimSize = %d %d %d\n", volume.m_Dims[AXIS_X],
          volume.m_Dims[AXIS_Y], volume.m_Dims[AXIS_Z]);
