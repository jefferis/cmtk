...
const char *Method = "CMTK "CMTK_VERSION" -- multi-resolution optimization of NMI with 'pruned' image intensities";
...
// prune intensities based on 128 histogram bins
  Registration.m_PreprocessorRef.m_PruneHistogramBins = 128;
  Registration.m_PreprocessorFlt.m_PruneHistogramBins = 128;
