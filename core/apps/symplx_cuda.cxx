...
bool ParseCommandLine ( const int argc, const char* argv[] )
{
  try
    ...
    cl.SetProgramInfo( cmtk::CommandLine::PRG_DESCR, "Compute the approximate symmetry plane of an image using GPU acceleration."
...
main ( const int argc, const char* argv[] ) 
{
  ...
  cmtk::Vector3D center = originalVolume->GetCenterOfMass();
  ...
  if ( OutputOnly ) 
	...
	volume = originalVolume; 
      ...
      cmtk::SmartPointer<cmtk::ImageSymmetryPlaneFunctionalDevice> functional( NULL );
	...
	functional = cmtk::SmartPointer<cmtk::ImageSymmetryPlaneFunctionalDevice>( new cmtk::ImageSymmetryPlaneFunctionalDevice( volume, valueRange ) );
	} 
      else
	{
	functional = cmtk::SmartPointer<cmtk::ImageSymmetryPlaneFunctionalDevice>( new cmtk::ImageSymmetryPlaneFunctionalDevice( volume ) );
	}
