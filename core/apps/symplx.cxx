...
main ( const int argc, const char* argv[] ) 
{
  ...
  if ( OutputOnly ) 
	...
	volume = originalVolume; 
      ...
      cmtk::SmartPointer<cmtk::ImageSymmetryPlaneFunctional> functional( NULL );
	...
	functional = cmtk::SmartPointer<cmtk::ImageSymmetryPlaneFunctional>( new cmtk::ImageSymmetryPlaneFunctional( volume, valueRange ) );
	} 
      else
	{
