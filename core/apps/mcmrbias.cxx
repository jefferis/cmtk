...
//  $Revision: 3977 $
//
//  $LastChangedDate: 2012-03-06 15:30:28 -0800 (Tue, 06 Mar 2012) $
//
...
#include <Segmentation/cmtkMultiChannelEntropyMinimizationIntensityCorrectionFunctional.h>
...
int doMain(const int argc, const char *argv[]) {
  try {
    ...
    cl.SetProgramInfo(cmtk::CommandLine::PRG_TITLE,
                      "Multi-Channel MR Image Intensity Bias Field Correction");
    cl.SetProgramInfo(
        cmtk::CommandLine::PRG_DESCR,
        "This program corrects intensity inhomogeneity artifacts in "
        "multiple-channel MR images simultaneously using a bias field "
        "estimated via joint and marginal entropy minimization.");
