...
#define CANONICAL_HOST_TYPE "i686-apple-darwin9.6.0"
...
#define DCMTK_PREFIX "/opt/local/dicom"

/* Define the default data dictionary path for the dcmdata library package */
#define DCM_DICT_DEFAULT_PATH "/opt/local/dicom/share/dcmtk/dicom.dic"
